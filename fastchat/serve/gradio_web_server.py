...
notice_markdown = ("""
# 🏔️ Chat with GalaxyAI
- GalaxyAI + Vicuna: An Open-Source Chatbot Impressing GPT-4 with 90% ChatGPT Quality.
...
def build_demo():
    with gr.Blocks(title="GalaxyAI Chatting", theme=gr.themes.Base(), css=css) as demo:
        state = gr.State()
